package net.azisaba.azisabareport.common.codec;
...
public class ResultSetValueDecoder implements ValueDecoder {
    ...
    public void push(@NotNull String label) {
        ValueDecoder.super.push(label);
        this.label = label;
    }

    @Override
    public void pop() {
        ValueDecoder.super.pop();
        this.label = null;
    }

    public @NotNull String getLabel() {
        return Objects.requireNonNull(label, "label is not set");
    }
